    ...
    >
      ...
      >
        ...
        >
          ...
          {/* 2. Headline - white with strong shadow for readability */}
          <h1
        ...
        {/* Subheadline - white with strong shadow for readability */}
        <p
            className={`max-w-[92%] break-words text-[13px] font-medium leading-[1.65] text-white min-[360px]:max-w-[95%] min-[360px]:text-sm min-[390px]:text-[15px] sm:max-w-xl sm:text-base sm:leading-[1.65] md:row-start-2 md:text-lg md:max-w-2xl ${isRTL ? "md:col-start-2" : "md:col-start-1"}`}
